...
This version was modified to fix deprecated APIs.
DESC
  s.homepage     = "https://github.com/iziz/libPhoneNumber-iOS.git"
  s.license      = 'Apache License, Version 2.0 (http://www.apache.org/licenses/LICENSE-2.0)'
  s.authors      = { "Bringg" => "bringg-ios-developers@bringg.com" }
  s.source       = { :git => "https://github.com/bringg/libPhoneNumber-iOS.git", :tag => s.version.to_s }
  s.libraries 	 = 'z'
